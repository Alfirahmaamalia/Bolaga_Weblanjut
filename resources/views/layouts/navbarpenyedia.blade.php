...
<nav class="bg-green-600 border-b shadow-sm text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div id="navbarMenu" class="hidden md:flex gap-6 items-center">
                ...
                <a href="{{ route('penyedia.kelolalapangan') }}"
                   class="text-white hover:bg-green-700 px-3 py-2 rounded-lg {{ request()->routeIs('penyedia.kelolalapangan') ? 'font-semibold text-blue-600' : '' }}">
                    Lapangan
                </a>

                <!-- Manajemen Booking -->
                <a href="{{ route('penyedia.manajemenbooking') }}"
                   class="text-white hover:bg-green-700 px-3 py-2 rounded-lg {{ request()->routeIs('penyedia.manajemenbooking') ? 'font-semibold text-blue-600' : '' }}">
                    Booking
                </a>

                <!-- Beranda -->
                <a href="{{ route('penyedia.dashboard') }}"
                   class="text-white hover:bg-green-700 px-3 py-2 rounded-lg {{ request()->routeIs('penyedia.dashboard') ? 'font-semibold text-blue-600' : '' }}">
                    Beranda
                </a>
        ...
        <div id="mobileMenu" class="md:hidden hidden pb-4 space-y-2">
            ...
            <a href="{{ route('penyedia.kelolalapangan') }}"
               class="block px-2 py-2 text-white hover:bg-green-700 px-3 py-2 rounded-lg {{ request()->routeIs('penyedia.kelolalapangan') ? 'font-semibold text-blue-600' : '' }}">
                Lapangan
            </a>

            <a href="{{ route('penyedia.manajemenbooking') }}"
               class="block px-2 py-2 text-white hover:bg-green-700 px-3 py-2 rounded-lg {{ request()->routeIs('penyedia.manajemenbooking') ? 'font-semibold text-blue-600' : '' }}">
                Booking
            </a>

            <a href="{{ route('penyedia.dashboard') }}"
               class="block px-2 py-2 text-white hover:bg-green-700 px-3 py-2 rounded-lg {{ request()->routeIs('penyedia.dashboard') ? 'font-semibold text-blue-600' : '' }}">
                Beranda
            </a>
